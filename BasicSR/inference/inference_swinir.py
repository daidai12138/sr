...
def main():
    ...
    sample_id_list=['N1','N2','N3','N4','N5','P1','P2','P3','P4','P5',]
    for sample_id in sample_id_list:
        parser = argparse.ArgumentParser()
        parser.add_argument('--input', type=str,
                            default=rf'D:\test\Super_resolution\data\img_data\10x10_raw\{sample_id}', help='input test image folder')
        parser.add_argument('--output', type=str, default=rf'D:\test\Super_resolution\data\HE_target\swinir0116\{sample_id}', help='output folder')
        parser.add_argument(
            '--task',
            type=str,
        ...
        parser.add_argument(
            '--model_path',
            type=str,
            default='experiments/pretrained_models/SwinIR/net_g_latest.pth')
